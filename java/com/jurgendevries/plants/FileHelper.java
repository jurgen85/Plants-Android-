...
public class FileHelper {
	...
	public static final int SHORT_SIDE_TARGET = 480;
	...
	public static byte[] reduceImageForUpload(byte[] imageData) {
		Bitmap bitmap = ImageResizer.resizeImageToSquare(imageData, SHORT_SIDE_TARGET);
	...
	public static String getImageFileName(Context context, Uri uri, String fileType) {
